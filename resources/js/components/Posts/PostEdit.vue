<template>
    <form @submit.prevent="updatePost(post)">
        ...
        <div class="mt-4">
            ...
            <input @change="post.thumbnail = $event.target.files[0]" type="file" name="" id="thumbnail">
        ...
        <!-- Buttons -->
        <div class="mt-4">
            <!--            <button style="background-color: blue;" class="px-3 py-2  text-white  rounded">Save</button>-->
            <button :disabled="isLoading" class="inline-flex items-center p disabled:cursor-not-allowed">
